import { COOL_OFF_MIN } from "./constant";

export const errorUserNotCreated = "Sorry! user not created";
export const errorUserNotFound = "User not found!";
export const errotTokenNotCreated = "Token not created";
export const errorEmailNotFound = "Incorrect credential!";
export const errorEmailNotSent = "Email not sent";
export const errorUserAlreadyExist = "User already exits";
export const errorIncorrectPassword = "Incorrect password";
export const errorPleaseProvideAccessToken = "Please provide valid token";
export const errorTokenExpire = "Authentication link expire";
export const errorUserNotVerified = "Email not verified";
